...
abstract class BaseXYDialog<T : BaseXYDialog<T>> : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewHandlerListener?.convertView(XYViewHolder.create(view), this)
        initView(view)
    ...
    override fun onStart() {
        ...
        dialog.window?.let {
            ...
            when {
                ...
                baseParams.widthDp > 0f -> params.width =
                        dp2px(
                            mContext,
                            baseParams.widthDp
                        )
